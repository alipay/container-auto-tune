...
public class ConfigInfoServiceTest {
    ...
    @Test
    void checkTuneIsEnableByAppID() {
        Boolean ff = configInfoService.checkTuneIsEnableByAppID(83);
    ...
    @Test
    void checkTuneAutoStatusByAppID() {
        configInfoService.findAPPConfigByAPPID(2222);
    }
