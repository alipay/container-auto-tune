...
/**
 * @author huoyuqi
 * @version JvmProfileFunction.java, v 0.1 2022年12月27日 11:40 上午 huoyuqi
 */
public class JvmProfileFunction extends BasicActionFunction {
    ...
    public AviatorObject call(Map<String, Object> env) {
        ...
        String taskName = String.format("%s日志分析%s", appName, constructDate());
        ...
        context.put("jvmProfilerWaitTime", 30 * 60 * 1000);
        context.put("STATUS", "INIT");
        gcLogAnalysisService.autoUpload(pod.getUnicode(), pod.getPodName(), RuleAction.JVM_PROFILER, taskName, context, appName);
        return new AviatorString("jvm_profile完成");
    }
