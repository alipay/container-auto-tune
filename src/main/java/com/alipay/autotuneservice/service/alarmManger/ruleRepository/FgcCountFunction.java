...
/**
 * @author huoyuqi
 * @version FgcCountFunction.java, v 0.1 2022年12月26日 8:40 下午 huoyuqi
 */
@Slf4j
public class FgcCountFunction extends BasicMetricCalcFunction {
    ...
    public AviatorObject call(Map<String, Object> env) {
        try {
            ...
            double sum = metricData.stream().mapToDouble(JvmMonitorMetricData::getFgc).sum();
            ...
            Optional.ofNullable(result).ifPresent(e -> {
                e.setResultMessage(e.getStatus() ? String.format("fgcCount 在最近%sS超过设置的阈值", ruleModel.getTime() / 1000) : "");
            });
