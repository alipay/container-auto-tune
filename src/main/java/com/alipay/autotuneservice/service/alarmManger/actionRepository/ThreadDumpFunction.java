...
/**
 * @author huoyuqi
 * @version ThreadDumpFunction.java, v 0.1 2022年12月27日 11:40 上午 huoyuqi
 */
public class ThreadDumpFunction extends BasicActionFunction {
    ...
    public AviatorObject call(Map<String, Object> env) {
        ...
        String taskName = String.format("%sThread日志分析%s", appName, constructDate());
        gcLogAnalysisService.autoUpload(pod.getUnicode(), pod.getPodName(), RuleAction.THREAD_DUMP, taskName, new HashMap<>(), appName);
        return new AviatorString("thread_dump完成");
    }
