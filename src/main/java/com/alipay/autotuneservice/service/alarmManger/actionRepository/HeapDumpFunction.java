...
/**
 * @author huoyuqi
 * @version HeapDumpFunction.java, v 0.1 2022年12月27日 11:40 上午 huoyuqi
 */
public class HeapDumpFunction extends BasicActionFunction {
    ...
    public AviatorObject call(Map<String, Object> env) {
        ...
        String taskName = String.format("%sHeap日志分析%s", appName, constructDate());
        gcLogAnalysisService.autoUpload(pod.getUnicode(), pod.getPodName(), RuleAction.HEAP_DUMP, taskName, new HashMap<>(), appName);
        return new AviatorString("heap_dump完成");
    }
