...
/**
 * @author dutianze
 * @version ExpertStrategy.java, v 0.1 2022年06月20日 19:28 dutianze
 */
public interface ExpertStrategy {

    ExpertEvalResult match(AppInfo appInfo, GarbageCollector garbageCollector,
                           List<ProblemType> problemTypeList,
                           List<ExpertKnowledge> expertKnowledgeLists);

    boolean use(List<ProblemType> problemTypeList);
}