...
public enum RuleAction {
     ...
     * java shared object memory maps
     */
    JAVA_INFO_RETRY(ReportType.SYSTEM, ResultType.BOOLEAN, "com.auto.tune.core.step.impl.action.JavaInfoStep"),

    /**
     * java shared object memory maps
     */
    FIX_THREAD_POOL(ReportType.SYSTEM, ResultType.BOOLEAN, "com.auto.tune.core.step.impl.action.FixThreadPoolStep"),

    /**
     * java shared object memory maps
     */
    ARTHAS_INSTALL(ReportType.SYSTEM, ResultType.BOOLEAN, "com.auto.tune.core.step.impl.action.ArthasStep"),
