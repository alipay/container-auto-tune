...
public class NodeInfo extends TableImpl<NodeInfoRecord> {
     ...
     */
    public final TableField<NodeInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "创建时间");
     ...
     */
    public final TableField<NodeInfoRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    private NodeInfo(Name alias, Table<NodeInfoRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("节点管理表"), TableOptions.table());
    }
    ...
    public List<UniqueKey<NodeInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<NodeInfoRecord>>asList(Keys.KEY_NODE_INFO_PRIMARY, Keys.KEY_NODE_INFO_NODE_INFO_NODE_NAME_ACCESS_TOKEN_UINDEX);
    }
