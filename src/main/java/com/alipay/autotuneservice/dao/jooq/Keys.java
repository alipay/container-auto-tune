...
public class Keys {
    ...
    public static final UniqueKey<AppInfoRecord> APP_INFO_APP_NAME_ACCESS_TOKEN_UINDEX = Internal.createUniqueKey(AppInfo.APP_INFO, DSL.name("APP_INFO_APP_NAME_ACCESS_TOKEN_UINDEX"), new TableField[] { AppInfo.APP_INFO.APP_NAME, AppInfo.APP_INFO.ACCESS_TOKEN, AppInfo.APP_INFO.NAMESPACE }, true);
    ...
    public static final UniqueKey<BaseLineRecord> CONSTRAINT_3 = Internal.createUniqueKey(BaseLine.BASE_LINE, DSL.name("CONSTRAINT_3"), new TableField[] { BaseLine.BASE_LINE.ID }, true);
