...
public class MeterMetaInfo extends TableImpl<MeterMetaInfoRecord> {
     ...
     */
    public final TableField<MeterMetaInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>tmaestro-lite.meter_meta_info.MODIFIED_TIME</code>.
     */
    public final TableField<MeterMetaInfoRecord, LocalDateTime> MODIFIED_TIME = createField(DSL.name("MODIFIED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    private MeterMetaInfo(Name alias, Table<MeterMetaInfoRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("存放注册监控的元数据信息"), TableOptions.table());
    }
    ...
    public UniqueKey<MeterMetaInfoRecord> getPrimaryKey() {
        return Keys.KEY_METER_META_INFO_PRIMARY;
    }

    @Override
    public List<UniqueKey<MeterMetaInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<MeterMetaInfoRecord>>asList(Keys.KEY_METER_META_INFO_PRIMARY);
    }
