...
public class TunePlan extends TableImpl<TunePlanRecord> {
     ...
     */
    public final TableField<TunePlanRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "创建时间");

    /**
     * The column <code>tmaestro-lite.tune_plan.UPDATE_TIME</code>. 修改时间
     */
    public final TableField<TunePlanRecord, LocalDateTime> UPDATE_TIME = createField(DSL.name("UPDATE_TIME"), SQLDataType.LOCALDATETIME(0), this, "修改时间");
    ...
    private TunePlan(Name alias, Table<TunePlanRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("调参计划"), TableOptions.table());
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TUNE_PLAN_TUNE_PLAN_APP_ID_INDEX);
    }
    ...
    public UniqueKey<TunePlanRecord> getPrimaryKey() {
        return Keys.KEY_TUNE_PLAN_PRIMARY;
    }

    @Override
    public List<UniqueKey<TunePlanRecord>> getKeys() {
        return Arrays.<UniqueKey<TunePlanRecord>>asList(Keys.KEY_TUNE_PLAN_PRIMARY);
    }
