...
public class AppInfo extends TableImpl<AppInfoRecord> {
     ...
     */
    public final TableField<AppInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "创建时间;创建时间");

    /**
     * The column <code>tmaestro-lite.app_info.UPDATED_TIME</code>. 更新时间;更新时间
     */
    public final TableField<AppInfoRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "更新时间;更新时间");
    ...
    private AppInfo(Name alias, Table<AppInfoRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("应用管理表"), TableOptions.table());
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.APP_INFO_APP_INFO__INDEX_CLUSTER, Indexes.APP_INFO_APP_INFO_ACCESS_TOKEN_CLUSTER_NAME_STATUS_INDEX, Indexes.APP_INFO_APP_INFO_APP_NAME_ACCESS_TOKEN_STATUS_INDEX, Indexes.APP_INFO_APP_INFO_ID_STATUS_INDEX);
    }
    ...
    public List<UniqueKey<AppInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<AppInfoRecord>>asList(Keys.KEY_APP_INFO_PRIMARY, Keys.KEY_APP_INFO_APP_INFO_APP_NAME_ACCESS_TOKEN_UINDEX);
    }
