...
public class StorageInfo extends TableImpl<StorageInfoRecord> {
     ...
     */
    public final TableField<StorageInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>tmaestro-lite.storage_info.UPDATED_TIME</code>.
     */
    public final TableField<StorageInfoRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    private StorageInfo(Name alias, Table<StorageInfoRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("s3永久文件存储卷"), TableOptions.table());
    }
    ...
    public UniqueKey<StorageInfoRecord> getPrimaryKey() {
        return Keys.KEY_STORAGE_INFO_PRIMARY;
    }

    @Override
    public List<UniqueKey<StorageInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<StorageInfoRecord>>asList(Keys.KEY_STORAGE_INFO_PRIMARY);
    }
