...
public class ConfigInfo extends TableImpl<ConfigInfoRecord> {
    ...
    public UniqueKey<ConfigInfoRecord> getPrimaryKey() {
        return Keys.KEY_CONFIG_INFO_PRIMARY;
    }

    @Override
    public List<UniqueKey<ConfigInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<ConfigInfoRecord>>asList(Keys.KEY_CONFIG_INFO_PRIMARY, Keys.KEY_CONFIG_INFO_CONFIG_INFO_APP_ID_INDEX);
    }
