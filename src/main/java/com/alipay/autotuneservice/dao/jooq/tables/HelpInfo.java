...
public class HelpInfo extends TableImpl<HelpInfoRecord> {
     ...
     */
    public final TableField<HelpInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "创建时间");
     ...
     */
    public final TableField<HelpInfoRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "更新时间");
    ...
    private HelpInfo(Name alias, Table<HelpInfoRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("agent安装帮助"), TableOptions.table());
    }
    ...
    public UniqueKey<HelpInfoRecord> getPrimaryKey() {
        return Keys.KEY_HELP_INFO_PRIMARY;
    }

    @Override
    public List<UniqueKey<HelpInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<HelpInfoRecord>>asList(Keys.KEY_HELP_INFO_PRIMARY);
    }
