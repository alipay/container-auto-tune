...
public class BaseLine extends TableImpl<BaseLineRecord> {
     ...
     */
    public final TableField<BaseLineRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    private BaseLine(Name alias, Table<BaseLineRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("基线管理表"), TableOptions.table());
    }
    ...
    public UniqueKey<BaseLineRecord> getPrimaryKey() {
        return Keys.KEY_BASE_LINE_PRIMARY;
    }

    @Override
    public List<UniqueKey<BaseLineRecord>> getKeys() {
        return Arrays.<UniqueKey<BaseLineRecord>>asList(Keys.KEY_BASE_LINE_PRIMARY);
    }
