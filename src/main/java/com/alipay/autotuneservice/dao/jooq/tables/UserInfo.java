...
public class UserInfo extends TableImpl<UserInfoRecord> {
     ...
     */
    public final TableField<UserInfoRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "创建时间");

    /**
     * The column <code>tmaestro-lite.user_info.UPDATED_TIME</code>. 更新时间
     */
    public final TableField<UserInfoRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "更新时间");
