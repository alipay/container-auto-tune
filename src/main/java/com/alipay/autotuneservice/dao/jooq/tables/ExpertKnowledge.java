...
public class ExpertKnowledge extends TableImpl<ExpertKnowledgeRecord> {
     ...
     */
    public final TableField<ExpertKnowledgeRecord, LocalDateTime> CREATED_TIME = createField(DSL.name("CREATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "创建时间");
     ...
     */
    public final TableField<ExpertKnowledgeRecord, LocalDateTime> UPDATED_TIME = createField(DSL.name("UPDATED_TIME"), SQLDataType.LOCALDATETIME(0), this, "更新时间");
    ...
    private ExpertKnowledge(Name alias, Table<ExpertKnowledgeRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("专家经验"), TableOptions.table());
    }
    ...
    public UniqueKey<ExpertKnowledgeRecord> getPrimaryKey() {
        return Keys.KEY_EXPERT_KNOWLEDGE_PRIMARY;
    }

    @Override
    public List<UniqueKey<ExpertKnowledgeRecord>> getKeys() {
        return Arrays.<UniqueKey<ExpertKnowledgeRecord>>asList(Keys.KEY_EXPERT_KNOWLEDGE_PRIMARY);
    }
