...
public interface ConfigInfoRepository {
    ...
    Integer save(ConfigInfoVO configInfoVO);

    Integer update(ConfigInfoVO configInfoVO);

    ConfigInfoVO findConfigByAPPID(Integer appid);

    List<ConfigInfoRecord> batchFindConfigByAppIds(List<Integer> appIds);
}