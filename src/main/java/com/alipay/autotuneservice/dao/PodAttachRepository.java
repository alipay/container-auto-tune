...
/**
 * @author dutianze
 * @version PodAttachRepository.java, v 0.1 2022年06月17日 11:27 dutianze
 */
public interface PodAttachRepository {

    PodAttach save(PodAttach podAttach);

    PodAttach findById(Integer id);
