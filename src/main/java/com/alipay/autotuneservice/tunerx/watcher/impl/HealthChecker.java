 ...
 */
public class HealthChecker extends EventChecker {

    private Function<TunePipeline, TuneContext> func;

    public HealthChecker(ApplicationContext applicationContext, TunePipeline tunePipeline) {
    ...
    public TuneStage tuneStage() {
        return TuneStage.HEALTHY_CHECK;
    }
