 ...
 */
@Slf4j
public class TuningProcessChecker extends EventChecker {

    public TuningProcessChecker(ApplicationContext applicationContext, TunePipeline tunePipeline) {
        super(applicationContext, tunePipeline);
    }

    @Override
    public TuneStage tuneStage() {
        return TuneStage.TUNING_PROCESS;
    }
