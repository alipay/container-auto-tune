...
public interface Model {
    ...
    interface CalciteSQLResult {
        ...
        class TableResult implements CalciteSQLResult {
            ...
            public com.alipay.autotuneservice.heap.util.pageutil.PageView<Entry> pv;

            public TableResult(List<String> columns, com.alipay.autotuneservice.heap.util.pageutil.PageView<Entry> pv) {
        ...
        class TreeResult implements CalciteSQLResult {
            ...
            public com.alipay.autotuneservice.heap.util.pageutil.PageView<JavaObject> pv;

            public int type = TREE;

            public TreeResult(com.alipay.autotuneservice.heap.util.pageutil.PageView<JavaObject> pv) {
                this.pv = pv;
            }
        }
