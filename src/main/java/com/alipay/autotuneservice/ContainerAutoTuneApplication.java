...
public class ContainerAutoTuneApplication {
    ...
    private static void addListener(SpringApplication application) {
        application.addListeners((ApplicationListener<ContextClosedEvent>) event -> H2DBManagerImpl.closeConn());
    }
}
