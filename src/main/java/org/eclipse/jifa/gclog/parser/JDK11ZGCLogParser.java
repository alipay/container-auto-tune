...
import static org.eclipse.jifa.gclog.model.GCEventType.ZGC_ALLOCATION_STALL;
...
import static org.eclipse.jifa.gclog.model.GCEventType.ZGC_CONCURRENT_RESET_RELOC_SET;
...
public class JDK11ZGCLogParser extends AbstractJDK11GCLogParser {
    ...
    private static void initializeParseRules() {
        ...
        withGCIDRules.add(new ParseRule.PrefixAndValueParseRule("Pause Class Unloading", JDK11ZGCLogParser::parsePhase));
